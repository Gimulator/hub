...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Sketch) DeepCopyInto(out *Sketch) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Sketch.
func (in *Sketch) DeepCopy() *Sketch {
	if in == nil {
		return nil
	}
	out := new(Sketch)
