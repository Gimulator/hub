...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GameConfig) DeepCopyInto(out *GameConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GameConfig.
func (in *GameConfig) DeepCopy() *GameConfig {
	if in == nil {
		return nil
	}
	out := new(GameConfig)
